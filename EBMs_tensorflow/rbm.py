...
class RestrictedBoltzmannMachine(EnergyBasedModel):
    ...
    def init_tensors(self):
        ...
        with self.graph.as_default():
            ...
            # variables
            b0 = tf.Variable(np.zeros(m0), name='b0', dtype='float32')
            b1 = tf.Variable(np.zeros(m1), name='b1',dtype='float32')
            w  = tf.Variable(np.zeros([m0, m1]), name='w', dtype='float32')
    ...
    def inference(self, x0=None, x1=None, num_steps=1, direction='auto'):
        """
